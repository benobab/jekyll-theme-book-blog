...
Gem::Specification.new do |spec|
  spec.name          = "jekyll-theme-book-blog"
  spec.version       = "0.0.1"
  spec.authors       = ["HTML5 UP", "Benjamin Lacroix"]
  spec.email         = ["bl@siwise.io"]

  spec.summary       = %q{A Jekyll version of the Prologue theme by HTML5 UP (original version of : Chris Bobbe).}
